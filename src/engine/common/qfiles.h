...
#define	MAX_QPATH		256		// extended for material paths
#define	MAX_QPATH_BSP	64		// BSP file format uses fixed 64-byte paths
...
typedef struct md3Tag_s {
	char		name[MAX_QPATH_BSP];	// tag name
	vec3_t		origin;
	vec3_t		axis[3];
} md3Tag_t;
...
typedef struct {
	...
	char	name[MAX_QPATH_BSP];	// polyset name
...
typedef struct {
	...
	char		name[MAX_QPATH_BSP];	// model name
